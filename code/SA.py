...
def simulated_annealing(initial_temperature, cooling_rate, num_iterations, w1,r,r1,min_v,max_v):
    sequence_car_info1 = randomize_sequence.randomize()
    current_objective = objective_func.objective_func(w1, r, r1, sequence_car_info1, min_v,max_v)
    ...
    for i in range(num_iterations):
        ...
        new_objective = objective_func.objective_func(w1, r, r1, sequence_car_info2, min_v,max_v)
