...
def binary_FFA(BFFA_parameters):
    ...
    for t in range(num_of_iteration) :
        ...
        for individual1 in range(population_size):  
            ...
            #sort attractivness 
            #changed it to population size instead of solution size
            ...
            #choose a random attractiv firefly in our case it is always 1 in the RC-BFFA
            ...
            while(not feasibility):
                #for each attaractive fire fly, rightnow they are one    
