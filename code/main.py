...
def generate_solution(merged_sequence_size, main_cars, ramp_cars, merging_position):
    ...
    return sequence_full_info_list, distances_to_merge, cars_ramp_merged_no
...
for _ in range(num_iterations):
    ...
    [new_solution, distances_to_merge, cars_ramp_merged_no] = generate_solution(merged_sequence_size,main_cars,ramp_cars,merging_position) 
    #check feasibility
    ...
    [current_solution, current_objective] = Simulated_annealing.simulated_annealing(delta_time,merging_position,
                                        ...
                                        w1, cars_ramp_no,cars_ramp_merged_no, new_solution, distances_to_merge)   
