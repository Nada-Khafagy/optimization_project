def platooning(ful_sequence,delta_time,decision_position,merging_position,desired_distance_bet_cars,alpha,beta,gamma):
    #flag = True
    #distances_to_merge=[]
    for i in range(len(ful_sequence)):
        car = list(ful_sequence.values())[i] #current car
        ...
        #get its leading car since it has a leader
            ...
            lead_car = list(ful_sequence.values())[i-1]
            #start platooning   
